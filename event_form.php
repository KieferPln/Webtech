...
<head>
    ...
    <form action="add_event.php" method="POST" class="add-event-container">
        ...
        <div class="subjects-container">
            ...
            <textarea id="description" name="description" type="text" rows="5" placeholder="Description" required></textarea>
            <input id="url" name="url" type="url" placeholder="Event URL"  required>
            <input id="date" name="date" type="date" min="<?php echo date("Y-m-d"); ?>" max="2025-12-31" required>
        </div>
        ...
        <div class="subjects-container">
            ...
            <input id="city" name="city" type="city" placeholder="City" required>
